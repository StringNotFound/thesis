...
def main():
    ...
    img_tf = transforms.Compose(
        [transforms.CenterCrop(size=size), transforms.ToTensor(),
    ...
    dataset_train = Places2(args.root, args.image_size, mask_tf, 'train')
    dataset_val = Places2(args.root, args.image_size, mask_tf, 'val')
